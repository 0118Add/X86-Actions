...
# 修改型号
#sed -i 's|echo\s+"?\$vendor\s+\$product"?\s*>.*|echo "Default string" > /tmp/sysinfo/model|' target/linux/x86/base-files/lib/preinit/01_sysinfo
...
rm -rf feeds/lienol/luci-app-mwan3helper
...
curl -sSL https://raw.githubusercontent.com/1980Add/turboacc/main/add_turboacc.sh -o add_turboacc.sh && bash add_turboacc.sh
...
wget -O target/linux/x86/base-files/lib/preinit/01_sysinfo https://raw.githubusercontent.com/0118Add/X86-Actions/main/general/01_sysinfo
